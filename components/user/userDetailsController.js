/*global wtBackoffice*/
wtBackoffice.controller('userDetailsController', ['$scope', '$routeParams', '$window', 'invoker', 'translate', 'processHandler', function ($scope, $routeParams, $window, invoker, translate, processHandler) {
    'use strict';
