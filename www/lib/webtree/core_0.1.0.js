...
/**
    ...
    @name authentication
**/
wtCore.service('authentication', ['sessionStorageProxy', function (sessionStorageProxy) {
    'use strict';
    
    //var sessionId = '';
    
    this.getSessionId = function () {
        return sessionStorageProxy.get('sessionId');
    };
    
    this.setSessionId = function (id) {
        sessionStorageProxy.add('sessionId', id);
    };
